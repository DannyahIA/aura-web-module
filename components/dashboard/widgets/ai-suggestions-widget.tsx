      ...
      <CardContent>
        <div className="space-y-3">
          <div className="p-3 rounded-lg bg-accent/10 border border-accent/20">
            <h4 className="text-sm font-semibold text-accent mb-1">💰 Savings Detected</h4>
            <p className="text-xs text-muted-foreground">
              You spent 15% less on delivery this month. Keep it up to save R$ 200!
            </p>
          </div>
          <div className="p-3 rounded-lg bg-primary/10 border border-primary/20">
            <h4 className="text-sm font-semibold text-primary mb-1">📊 Expense Analysis</h4>
            <p className="text-xs text-muted-foreground">
              Your transportation expenses increased 20%. Consider using public transport more often.
            </p>
          </div>
        </div>
      </CardContent>
